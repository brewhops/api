...
export function routes(): Router {
  ...
  // [POST] section
  router.post('/', validate(RecipeValidator.createRecipe), requireAuthentication, async (req, res, next) => controller.createRecipe(req, res, next));

  // [PATCH] section
  router.patch('/id/:id', validate(RecipeValidator.updateRecipe), requireAuthentication, async (req, res, next) => controller.updateRecipe(req, res, next));
